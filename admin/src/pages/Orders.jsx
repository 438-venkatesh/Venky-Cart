...
import { currency } from '../App'; // keep if currency is from here
import { toast } from 'react-toastify';
import { assets } from '../assets/assets';

const Orders = ({ token }) => {
  const backendUrl = import.meta.env.VITE_BACKEND_URL;  // updated backendUrl
  ...
  const fetchAllOrders = async () => {
    ...
    try {
      const response = await axios.post(
        `${backendUrl}/api/order/list`, // note the slash before api
        {},
        { headers: { token } }
      );
